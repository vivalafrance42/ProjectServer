...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new()
    {
        ...
        Description = "APIs for Menu Items from Food Places",
        Title = "Menu Items from Food Places APIs",
        Version = "V1"
    });
...
builder.Services.AddDbContext<FoodSourceContext>(options =>
options.UseSqlServer(x));

builder.Services.AddIdentity<FoodPlaceMenuItemsUser, IdentityRole>()
    .AddEntityFrameworkStores<FoodSourceContext>();
